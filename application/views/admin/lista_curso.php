<?php
$this->template->menuAdmin('admin/mostrar_tabela_curso');
?>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5><i class="fa fa-dashboard"></i> Cursos</h5>
    </header>

    <div class="w3-light-gray">
        <div class="w3-container w3-content w3-margin">       
            <div class="w3-left">
                <a href="<?php echo base_url() ?>curso/inserir_curso" class="w3-button w3-blue w3-padding-16 w3-large"><i class="fa fa-plus"> Inserir novo curso</i></a>
            </div>           
        </div>  
                ...
                <table class="w3-table-all w3-card-4">
                    ...
                    <?php foreach ($curso as $row): ?>  
                        <tr class="w3-left-align">                            
                            ...
                            <td>
                                <a class="w3-button w3-hover-blue" href="<?php echo base_url() ?>curso/editar_curso/<?php echo $row->id; ?>">Editar</a><br>              
                                ...
                                <div id="id<?php echo $row->id; ?>" class="w3-modal">
                                    <div class="w3-modal-content w3-animate-zoom w3-card-4">
                                        ...
                                        <div class="w3-container w3-padding-32 w3-margin-bottom">
                                            ...
                                            <a class="w3-button w3-red" href="<?php echo base_url() ?>curso/deletar_curso/<?php echo $row->id; ?>">Deletar</a>
                                        </div>
                                    </div>
                                </div>
                            </td>              
