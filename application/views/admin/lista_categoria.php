<?php
$this->template->menuAdmin('admin/categoria');
?>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <header class="w3-container" style="padding-top:22px">
        <h5><i class="fa fa-dashboard"></i> Categorias</h5>
    </header>
    ...
    <div class=" w3-light-gray">
        <div class="w3-container w3-content w3-margin">       
            <div class="w3-left">
                <a href="<?php echo base_url() ?>produto/inserir_categoria" class="w3-button w3-green w3-padding-16 w3-large"><i class="fa fa-plus"> Inserir nova Categoria</i></a>
            </div>   
        </div>
                    ...
                    <?php foreach ($categorias as $row): ?>  
                        <tr class="w3-left-align">                            
                            ...
                            <td><!-- ****** modal editar / deletar ******* < -->
                                <a class="w3-button w3-hover-blue" href="<?php echo base_url() ?>produto/editar_categoria/<?php echo $row->id; ?>">Editar</a><br>
                                ...
                                <div id="id<?php echo $row->id; ?>" class="w3-modal">
                                    <div class="w3-modal-content w3-animate-zoom w3-card-4">
                                        <header class="w3-container">                                         
                                            <p>Deseja realmente deletar categoria?</p>
                                        </header>
